   ...
   4362                      31 _m_entities::
   4362                      32 	.ds 315
   449D                      33 _m_zero_type_at_the_end::
   449D                      34 	.ds 1
   449E                      35 _m_next_free_entity::
   449E                      36 	.ds 2
   44A0                      37 _m_num_entities::
   44A0                      38 	.ds 1
                             39 ;--------------------------------------------------------
                             40 ; ram data
                             41 ;--------------------------------------------------------
   ...
   4033 33            [ 6]   73 	inc	sp
   4034 21 62 43      [10]   74 	ld	hl, #_m_entities
   4037 E5            [11]   75 	push	hl
   4038 CD DF 42      [17]   76 	call	_cpct_memset
                             77 ;src/man/entity.c:15: m_next_free_entity = m_entities;
   403B 21 62 43      [10]   78 	ld	hl, #_m_entities
   403E 22 9E 44      [16]   79 	ld	(_m_next_free_entity), hl
                             80 ;src/man/entity.c:16: m_num_entities = 0;
   4041 21 A0 44      [10]   81 	ld	hl,#_m_num_entities + 0
   4044 36 00         [10]   82 	ld	(hl), #0x00
                             83 ;src/man/entity.c:17: m_zero_type_at_the_end = e_type_invalid;
   4046 21 9D 44      [10]   84 	ld	hl,#_m_zero_type_at_the_end + 0
   ...
   405A 21 A0 44      [10]  102 	ld	hl, #_m_num_entities+0
   ...
   4061 01 62 43      [10]  114 	ld	bc, #_m_entities+0
   ...
   4071 CD C0 42      [17]  129 	call	___sdcc_call_hl
   ...
   408C 2A 9E 44      [16]  150 	ld	hl, (_m_next_free_entity)
   ...
   40B0 CD D7 42      [17]  176 	call	_cpct_memcpy
   ...
   40B6 ED 43 9E 44   [20]  183 	ld	(_m_next_free_entity), bc
                            184 ;src/man/entity.c:72: --m_num_entities;
   40BA 21 A0 44      [10]  185 	ld	hl, #_m_num_entities+0
   ...
   40CA 21 62 43      [10]  209 	ld	hl, #_m_entities+0
   ...
   40E2 21 A0 44      [10]  236 	ld	hl, #_m_num_entities
