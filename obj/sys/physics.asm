...
;src/sys/physics.c:6: if(newx > e->x) 
	...
	sub	a, -2 (ix)
	jr	NC,00102$
;src/sys/physics.c:7: man_entity_destroy( e );
	push	bc
...
00104$:
	...
	pop	ix
	ret
;src/sys/physics.c:13: void sys_physics_update() {
;	---------------------------------
; Function sys_physics_update
; ---------------------------------
_sys_physics_update::
;src/sys/physics.c:15: man_entity_forall( sys_physics_update_one_entity );
